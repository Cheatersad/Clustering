...
def main():
   ...
   # Select specific columns
    ...
    # Check the dimensions of selected_data
    print(selected_data.shape)

    # Calculate Total_PCMD using column names
    selected_data.loc[:, 'Total_PCMD'] = selected_data.iloc[:, -3] + selected_data.iloc[:, -2] + selected_data.iloc[:, -1]
